...
public class ManageOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(451, 14, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 122, 360, 340));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 120, 407, 344));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setText("Cart");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 100, -1, -1));
        ...
        tableCart.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ID", "Name", "Price", "Quantity", "Description", "Sub Total"
            }
        ));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 120, 352, 340));
        ...
        getContentPane().add(txtCustomerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 540, 350, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setText("Mobile Number");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 580, -1, -1));

        txtCustomerMobile.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtCustomerMobile, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 600, 350, -1));
        ...
        getContentPane().add(txtCustomerEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 660, 350, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel9.setText("Selected Product:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(451, 484, -1, -1));
        ...
        getContentPane().add(txtProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 530, 390, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel11.setText("Product Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 570, -1, -1));

        txtProPrice.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtProPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 590, 390, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setText("Product Description");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 630, -1, -1));

        txtProDesc.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtProDesc, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 650, 390, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel13.setText("Order Quantity");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 680, -1, -1));

        txtOrderQuantity.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtOrderQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 700, 390, -1));
        ...
        getContentPane().add(btnAddCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(447, 740, 400, -1));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel14.setText("Total Amount :");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 470, -1, -1));

        lblFinalTotalPrice.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblFinalTotalPrice.setText("00000");
        getContentPane().add(lblFinalTotalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 470, -1, -1));

        btnSaveOrder.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        getContentPane().add(btnSaveOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 510, 352, -1));
        ...
        getContentPane().add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 570, 352, -1));
        ...
        getContentPane().add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 630, 352, -1));

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Orders_background.png"))); // NOI18N
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1370, -1));
    ...
    private void tableCustomerListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCustomerListMouseClicked
        ...
        txtCustomerMobile.setText(mobileNumber);
    ...
    private void tableProductListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableProductListMouseClicked
        ...
        txtProPrice.setText(productPrice);

        String productDescription = model.getValueAt(index, 4).toString();
        txtProDesc.setText(productDescription);
    ...
    private void btnAddCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCartActionPerformed
        ...
        if (!noOfUnites.equals("")) {
            ...
            String productDescription = txtProDesc.getText();
                ...
                if (tableCart.getRowCount() != 0) {
                    for (int i = 0; i < tableCart.getRowCount(); i++) {
                        if (Integer.parseInt(model.getValueAt(i, 0).toString()) == productPK) {
                            ...
                            JOptionPane.showConfirmDialog(null, "Product already exist in cart");

                        }
                    }
                }
                if (checkProductAlreadyExistInCart == 0) {
                    model.addRow(new Object[]{productPK, productName, noOfUnites, productPrice, productDescription, totalPrice});
            ...
            JOptionPane.showConfirmDialog(null, "No of quantity and product field is required");
        }
    ...
    private void btnSaveOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveOrderActionPerformed
        if (finalTotalPrice != 0 && !txtCustomerName.getText().equals("")) {
                ...
                for (int i = 0; i < tableCart.getRowCount(); i++) {
                    try {
                        ...
                        st.executeUpdate(
                                ...
                                + Integer.valueOf(dtm.getValueAt(i, 2).toString())
                                + " where product_pk="
                                + Integer.valueOf(dtm.getValueAt(i, 0).toString())
                        );
            ...
            try {
                ...
                doc.open();
                Paragraph projectName = new Paragraph("                                             Invrntory Management System\n");
                doc.add(projectName);
